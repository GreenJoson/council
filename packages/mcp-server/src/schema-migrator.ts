...
import {
  assertVersionSixMigrationSource,
  migrateVersionSeven,
...
import {
  assertVersionEightMigrationSource,
  migrateVersionNine,
} from "./schema-v9-migration.js";
import {
  assertVersionNineMigrationSource,
  migrateVersionTen,
} from "./schema-v10-migration.js";
import {
  assertVersionTenMigrationSource,
...
import {
  assertVersionTwelveMigrationSource,
  migrateVersionThirteen,
} from "./schema-v13-migration.js";
import {
  assertVersionThirteenMigrationSource,
...
const CANONICAL_MIGRATION_STEPS: readonly Readonly<{
  ...
  { version: 13, apply: (database) => { migrateVersionThirteen(database, false); } },
...
export function assertCouncilSchema(database: DatabaseSync): void {
  ...
  const expectedMigrations = [
    ...
    [13, "decision-package-acceptance"],
